...
graph TB
    ...
    subgraph Gateway["API GATEWAY LAYER"]
        API[API Gateway<br/>- Rate Limiting 10k req/s<br/>- OAuth2/JWT Auth<br/>- TLS 1.3<br/>- DDoS Protection]
    end
...
- **Trigger**: PGSI score ΓëÑ 8 or clinical referral
...
Response: {excluded, risk_level, screening_required}
    Γåô
Operator Decision:
  - Excluded ΓåÆ Block registration/betting
  - Low Risk ΓåÆ Allow with monitoring
  - High Risk ΓåÆ Trigger screening
```
...
- **Log Aggregation**: Logstash ΓåÆ Elasticsearch ΓåÆ Kibana
