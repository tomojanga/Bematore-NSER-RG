      ...
      <div className="relative flex items-center justify-center min-h-screen py-12 px-4">
        <div className="w-full max-w-2xl">
          ...
          <div className="text-center mb-8">
            <h1 className="text-4xl font-bold text-white mb-2">{t('auth.operator_registration')}</h1>
            <p className="text-gray-300">{t('auth.join_nser')}</p>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-xl border border-white/20 rounded-2xl shadow-2xl p-8">
            ...
            {success && (
              <div className="text-center py-12">
                ...
                <h3 className="text-2xl font-bold text-white mb-2">{t('auth.registration_success')}</h3>
                <p className="text-gray-300 mb-6">{t('auth.pending_approval_msg')}</p>
                ...
                <div className="mb-8 flex gap-4">
                  {(['business', 'contact', 'credentials'] as const).map((step, idx) => (
                    <div key={step} className="flex-1">
                      ...
                      <p className="text-xs text-gray-400 mt-2 capitalize">{t(`auth.step_${step}`)}</p>
                    </div>
                  ))}
                </div>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {currentStep === 'business' && (
                    <div className="space-y-4 animate-fade-in">
                      <h2 className="text-xl font-semibold text-white mb-6">{t('auth.business_info')}</h2>
                      
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.operator_name')} *</label>
                        <input
                          type="text"
                          required
                          value={formData.name}
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.registration_number')} *</label>
                        <input
                          type="text"
                          required
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.license_type')} *</label>
                        <select
                          required
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.license_number')} *</label>
                        <input
                          type="text"
                          required
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.license_issued')} *</label>
                          <input
                            type="date"
                            required
                        ...
                        <div>
                          <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.license_expiry')} *</label>
                          <input
                            type="date"
                            required
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.website_url')}</label>
                        <input
                          type="url"
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.physical_address')} *</label>
                        <textarea
                          required
                          rows={2}
                  ...
                  {currentStep === 'contact' && (
                    <div className="space-y-4 animate-fade-in">
                      <h2 className="text-xl font-semibold text-white mb-6">{t('auth.contact_info')}</h2>
                      
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.email_address')} *</label>
                        <input
                          type="email"
                          required
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.contact_person')} *</label>
                        <input
                          type="text"
                          required
                      ...
                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.contact_person_phone')} *</label>
                        <input
                          type="tel"
                          required
                  ...
                  {currentStep === 'credentials' && (
                    <div className="space-y-4 animate-fade-in">
                      <h2 className="text-xl font-semibold text-white mb-6">{t('auth.create_account')}</h2>
                      ...
                      <div>
                        ...
                        <input
                          ...
                          placeholder="••••••••"
                        />
                        <p className="text-xs text-gray-400 mt-2">{t('auth.password_requirements')}</p>
                      </div>

                      <div>
                        <label className="block text-sm font-medium text-gray-200 mb-2">{t('auth.confirm_password')} *</label>
                        <input
                          type="password"
                          required
