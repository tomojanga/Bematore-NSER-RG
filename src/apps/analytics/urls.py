...
urlpatterns = [
    ...
    path('realtime/', views.RealTimeStatsView.as_view(), name='realtime_stats'),
    ...
    # User Analytics
    path('users/growth/', views.UserGrowthAnalyticsView.as_view(), name='user_growth'),
    path('users/demographics/', views.UserDemographicsView.as_view(), name='user_demographics'),
    path('users/engagement/', views.UserEngagementView.as_view(), name='user_engagement'),
    
    # Operator Analytics
    path('operators/performance/', views.OperatorPerformanceView.as_view(), name='operator_performance'),
